...
#ifndef ESAT_OBCStoreTelemetryTelecommand_h
#define ESAT_OBCStoreTelemetryTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for OBC_STORE_TELEMETRY.
// Used by ESAT_OBCSubsystem.
class ESAT_OBCStoreTelemetryTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the OBC_STORE_TELEMETRY telecommand.
    static const byte OBC_STORE_TELEMETRY = 0x01;
...
// Global instance of ESAT_OBCStoreTelemetryTelecommandClass.
// Used by ESAT_OBCSubsystem.
extern ESAT_OBCStoreTelemetryTelecommandClass ESAT_OBCStoreTelemetryTelecommand;

#endif /* ESAT_OBCStoreTelemetryTelecommand_h */
