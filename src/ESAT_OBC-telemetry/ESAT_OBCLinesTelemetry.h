...
#ifndef ESAT_OBCLinesTelemetry_h
...
// to fill the OBC lines telemetry packet.
extern ESAT_OBCLinesTelemetryClass ESAT_OBCLinesTelemetry;

#endif /* ESAT_OBCLinesTelemetry_h */
